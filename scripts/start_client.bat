...
REM ============================================
REM Normalize TRACKER_ARG to TRACKER_URL
REM ============================================
...
REM Check for IPv4 without port
...
REM Hostname with or without port
...
if "!TRACKER_URL:~-1!"=="/" (
    set "TRACKER_URL=!TRACKER_URL:~0,-1!"
)
...
echo   --data-dir DIR        Local storage
